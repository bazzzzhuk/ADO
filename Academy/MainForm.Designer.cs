namespace Academy
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabControl.Controls.Add(this.tabPageDirection);
			...
			// tabPageDirection
			// 
			this.tabPageDirection.Controls.Add(this.dgvDirections);
			this.tabPageDirection.Location = new System.Drawing.Point(4, 22);
			this.tabPageDirection.Name = "tabPageDirection";
			this.tabPageDirection.Padding = new System.Windows.Forms.Padding(3);
			this.tabPageDirection.Size = new System.Drawing.Size(792, 402);
			this.tabPageDirection.TabIndex = 2;
			this.tabPageDirection.Text = "Direction";
		...
		private System.Windows.Forms.TabPage tabPageDirection;
